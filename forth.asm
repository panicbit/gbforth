...
SECTION FRAGMENT "Header", ROM0[$100]
    jp EntryPoint

    ds $150 - @, 0 ; Make room for the header

SECTION FRAGMENT "Code", ROM0[$200]
EntryPoint:
    jp START
...
START:
    ...
    ld a, HIGH(return_stack_start)
    ld [return_stack_pointer + 1], a
    ld a, LOW(return_stack_start)
...
SECTION FRAGMENT "Data Segment", WRAM0
DataSagment::

SECTION "Return Stack Start", WRAM0[$D000 - 2]
return_stack_start::
